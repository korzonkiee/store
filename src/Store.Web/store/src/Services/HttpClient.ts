...
export class HttpClient {
    ...
    protected get<TResult, TError = {}>(url: string): Promise<Responses.ApiResponse<TResult, TError>> {
        return this.executeRequest<TResult, TError>(url, RequestMethod.Get);
    }

    protected post<TResult, TError = {}>(url: string, data?: any): Promise<Responses.ApiResponse<TResult, TError>> {
        return this.executeRequest<TResult, TError>(url, RequestMethod.Post, data);
    }

    protected put<TResult, TError = {}>(url: string, data?: any): Promise<Responses.ApiResponse<TResult, TError>> {
        return this.executeRequest<TResult, TError>(url, RequestMethod.Put, data);
    }

    protected delete<TResult, TError = {}>(url: string, data?: any): Promise<Responses.ApiResponse<TResult, TError>> {
        return this.executeRequest<TResult, TError>(url, RequestMethod.Delete, data);
    }

    private async executeRequest<TResult, TError = {}>(url: string, method: RequestMethod, data?: any): Promise<Responses.ApiResponse<TResult, TError>> {
    ...
    private async handleResponse<TResult, TError>(response: Response, makeRequest?: () => Promise<Response>): Promise<Responses.ApiResponse<TResult, TError>> {
